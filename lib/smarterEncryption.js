...
const SMARTER_ENCRYPTION_PRIORITY = 100
...
/**
 * Create a rule to disable automatic HTTPS upgrades for a set of domains.
 * @param {string[]} domains
 * @param {number | undefined} id (optional) rule ID
 * @returns {}
 */
function createSmarterEncryptionExceptionRule (domains, id = undefined) {
    return {
        rule: {
            id,
            priority: SMARTER_ENCRYPTION_PRIORITY,
...
exports.createSmarterEncryptionExceptionRule = createSmarterEncryptionExceptionRule
